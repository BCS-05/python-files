...
class LoginPage:
    def __init__(self,win):
        ...
        self.title_label = Label(self.win, text="Hotel Management System", font=('Arial', 35, 'bold'),fg='yellow',background="purple",borderwidth=15, relief=RIDGE)
        ...
        def check_login():
            if username.get() == "clinton" and password.get() == "12345678":
